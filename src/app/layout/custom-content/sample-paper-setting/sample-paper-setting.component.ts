...
@Component({
  selector: 'app-sample-paper-setting',
  templateUrl: './sample-paper-setting.component.html',
  styleUrls: ['./sample-paper-setting.component.scss']
})
export class SamplePaperSettingComponent implements OnInit {
  ...
  ishaveInstitutePaper: boolean = false;
  ...
  getSubject(classId){
    ...
    getSamplePapers(SubjectID) {
      this.samplePapers = [];
      this.customService.getPapersListByType(SubjectID,2).
      subscribe(result =>{
